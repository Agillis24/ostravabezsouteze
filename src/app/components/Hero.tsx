  ...
  return (
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-b from-neutral-50 to-white relative">
      <div className="max-w-6xl mx-auto px-6 py-12 md:py-24 text-center">
        ...
        <h1 className="text-3xl sm:text-4xl md:text-7xl font-serif mb-8 text-neutral-900 leading-tight max-w-5xl mx-auto">
          9 let, zhruba 55 milionů korun a otázka, proč se senior taxi v Ostravě dlouhodobě nesoutěží otevřeně
        </h1>

        <p className="text-base md:text-xl lg:text-2xl text-neutral-600 mb-12 max-w-4xl mx-auto leading-relaxed">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-8 max-w-3xl mx-auto mb-16">
          <div className="bg-white p-4 md:p-6 rounded-lg shadow-sm border border-neutral-200">
            <div className="text-2xl md:text-4xl font-serif text-red-900 mb-2">55 mil. Kč</div>
            <div className="text-sm text-neutral-600">Celková vynaložená částka</div>
          </div>
          <div className="bg-white p-4 md:p-6 rounded-lg shadow-sm border border-neutral-200">
            <div className="text-2xl md:text-4xl font-serif text-red-900 mb-2">9 let</div>
            <div className="text-sm text-neutral-600">Období 2017–2026</div>
          </div>
          <div className="bg-white p-4 md:p-6 rounded-lg shadow-sm border border-neutral-200">
            <div className="text-2xl md:text-4xl font-serif text-red-900 mb-2">1 dodavatel</div>
